...
const Checker = () => {
  ...
  const fetchData = async () => {
    ...
    const url = `https://script.google.com/macros/s/AKfycbxfs10HxZnBhXJCB8migjEn9BVyHPk-VgZXS2HlJYMdPxPZMijgYBkHcMyhGpH82k7Udw/exec?spreadsheetId=${extractIdFromURL(GsURL)}&cb=${cacheBuster}`;
    setSheetData({});
    setSelectedSheet("");
    setBuffer("");
    setSelectedTypes("");
