    ...
    for name in url_json:
        ...
        for video in video_list:
            ...
            while True:
                try:
                    ...
                    logger.warning(e + " when opening " + video[1])
                    time.sleep(10)
            ...
            for url_name in urls:
                ...
                while True:
                    try:
                        ...
                        logger.warning(e + " when opening " + url_name)
                        resp = response.url
                        break
                    except Exception as e:
                        logger.warning(e + " when opening " + url_name)
        ...
        while True:
            try:
                ...
                logger.warning(e + " when getting the worksheets. (1)")
                time.sleep(10)
        ...
        while True:
            try:
                ...
                logger.warning(e + " when getting the worksheets. (2)")
                time.sleep(10)
            ...
            if worksheet.title in full_list:
                while True:
                    try:
                        ...
                        logger.warning(e + " when updating the worksheet.")
                        time.sleep(10)
